...
public class DBOPERATION {
   static Scanner scan = new Scanner(System.in);
    ...
    public static void INSERT_DATA() {
        ...
        System.out.println("Does " + DBFileName + " contain any table ?(Type Yes or No)");
        String check = scan.next();
        if (check.toLowerCase().equals("no")) {
            CREATE_TABLE(DBFileName, DBDirectory);
        } else if(check.toLowerCase().equals("yes")){
    ...
    public static void UPDATE_OPERATION(){
        ...
        Table=scan.nextLine();
        System.out.println("Choose the respective type of data the table has.(1.LOGIN-DETAILS or 2.CREDIT-CARD or 3.DEBIT-CARD)\nEnter options (1,2 or 3) : ");
        ...
        switch(num){
            case 1:
                ...
                while(flag) {
                    ...
                    System.out.println("Enter the row number in which data has to be updated : ");
                    int n = scan.nextInt();
            ...
            case 1:
                ...
                while (flag) {
                    ...
                    try {
                        ...
                        System.out.println("ID\t\tACCOUNTNAME\t\tUSERNAME\tPASSWORD");

                        while (rs.next()) {

                            String id = rs.getString("ID");
                            String CARDNUMBER = rs.getString("ACCOUNTNAME");
                            String EXPIRYDATE = rs.getString("USERNAME");
                            String CVV = rs.getString("PASSWORD");
