...
public class Main {
    ...
    public static void INPUT_ANALYSE(){
        ...
        for(int i=0;i<command_split.length;i++){
            if(command_split[i].toLowerCase().equals("generate-password")){
                System.out.println("\n\nGENERATING PASSWORD\n");
                 getAlphaNumericString();
            }else if(command_split[i].toLowerCase().equals("create-database")){
                System.out.println("\n\nCREATING DATABASE : \n");

                DBop.CREATE_DATABASE();
                System.out.println("Database Created!!!");
            } else if (command_split[i].toLowerCase().equals("insert-data")) {
                System.out.println("\n\nINSERTING DATA : \n");

                DBop.INSERT_DATA();


            } else if (command_split[i].toLowerCase().equals("update-data")) {
                System.out.println("\n\nUPDATE OPERATION\n");
